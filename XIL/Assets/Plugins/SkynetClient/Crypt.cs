...
namespace SkynetClient
{
    public class Crypt
    {
        ...
        public static void SetDesKey(byte[] k)
        {
            if (k == null || k.Length != 8) throw new Exception("bad key size");
            key = k;
        }
        ...
        {
            return System.Convert.FromBase64String(sourceString);
        }

        static public string Base64Encode(byte[] sourceString)
        {
            return System.Convert.ToBase64String(sourceString);
        }
