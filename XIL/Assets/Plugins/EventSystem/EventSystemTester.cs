...
namespace  XIL.EventSystem
{
    ...
    public class EventSystemTester : MonoBehaviour, IEventListener
    {
        ...
        {
            EventDispatcher.instance.MainEventManager.AddEventListener<string>(EventId.TestUserInput, this.OnUserInput);
        }
        ...
        {
            EventDispatcher.instance.MainEventManager.RemoveEventListener<string>(EventId.TestUserInput, this.OnUserInput);
        }
        ...
        void Update ()
        {
            ...
            {
                // trigger the event.
                EventDispatcher.instance.MainEventManager.TriggerEvent<string>(EventId.TestUserInput, "Hello World!");
            }
        }
    }
}
