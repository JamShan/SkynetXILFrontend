...
namespace GameProtoS2CSprotoType { 
...
public class GameProtoS2CProtocol : ProtocolBase {
	public static  GameProtoS2CProtocol Instance = new GameProtoS2CProtocol();
	private GameProtoS2CProtocol() {
		Protocol.SetProtocol<push> (push.Tag);
		Protocol.SetRequest<GameProtoS2CSprotoType.push.request> (push.Tag);
